defmodule Core.Config.Schema.Errors do
  @moduledoc """
  Pure helpers for flattening Ecto changeset errors into a single human-
  readable string suitable for `{:error, {:invalid_workflow_config, message}}`.
  """
